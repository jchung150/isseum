...
export const equipment: EquipmentItem[] = [
  ...
  {
    category: '영상',
    name: '100인치 삼성 4K 스마트 TV',
    req: '상시 세팅',
    desc: '메인 홀 벽면에 고정된 100인치 4K 스마트 TV입니다. 무선 미러링과 HDMI 유선 입력을 모두 지원해 발표 자료와 브랜드 영상을 바로 띄울 수 있습니다.',
    spec: '100형 4K · 미러링 · HDMI',
    qty: '1대',
    place: '메인 홀 정면 벽면 고정',
    slot: '100인치 삼성 4K 스마트 TV (1800×1200)',
  ...
  },
  {
    ...
    name: '기본형 의자',
    req: '사전 요청',
    desc: '등판과 좌판에 패딩이 들어가 오래 앉아 있어도 불편하지 않은 기본형 의자입니다. 극장형, U자형, 아일랜드형 등 원하는 레이아웃을 자유롭게 구성할 수 있습니다.',
    spec: '등·좌판 패딩 · 적층 보관',
    qty: '75개',
    place: '메인 홀 · 프로젝트 룸',
    slot: '기본형 의자 (1800×1200)',
    summary: { name: '기본형 의자', spec: '등·좌판 패딩 · 자유로운 레이아웃 구성' },
  },
  {
    category: '가구',
    name: '이동식 다목적 테이블',
    req: '사전 요청',
    desc: '바퀴가 달린 퍼시스 2인·3인용 접이식 테이블입니다. 필요할 때 바로 펼치고 행사 중에도 손쉽게 이동할 수 있어 워크숍, 접수처, 굿즈 판매대 등 다양한 용도로 활용됩니다.',
    spec: '퍼시스 2인·3인용 · 바퀴 · 접이식',
    qty: '25개',
  ...
  },
  {
    ...
    req: '사전 요청',
    desc: '커버를 교체할 수 있어 행사 톤앤매너에 맞춘 연출이 가능합니다. 소파와 라운지 체어를 조합해 네트워킹 라운지나 인터뷰 촬영 구도로 배치할 수 있습니다.',
  ...
  },
  {
    ...
    name: '초고속 기가 Wi-Fi',
    req: '상시 제공',
    desc: '행사 전용으로 분리된 기가 회선을 사용합니다. 참석자가 많은 행사에서도 끊김 없이 접속할 수 있으며, 접속 정보는 공간 내부와 안내 문자를 통해 확인하실 수 있습니다.',
    spec: '기가 인터넷',
    qty: '-',
    place: '전 영역',
...
export const equipmentNotes = [
  ...
  {
    label: '조작 주의 — ',
    text: '믹서·프로젝터 설정을 임의로 변경하거나 케이블을 분리하지 말아 주세요. 문제가 있을 경우 호스트에게 바로 연락 주시면 됩니다.',
  },
  {
    label: '파손 및 분실 — ',
